...
class InMemoryCSRFStorage:
    ...
    def __init__(self) -> None:
        self._store: Dict[str, CSRFTokenRecord] = {}

    def save(self, record: CSRFTokenRecord) -> None:
        self._store[record.random_token] = record

    def get(self, random_token: str) -> Optional[CSRFTokenRecord]:
...
class DuckDBCSRFStorage:
    ...
    def get(self, random_token: str) -> Optional[CSRFTokenRecord]:
        ...
        return CSRFTokenRecord(
            random_token=res[0], created_at=res[1], session_id=res[2], used=res[3]
        )
